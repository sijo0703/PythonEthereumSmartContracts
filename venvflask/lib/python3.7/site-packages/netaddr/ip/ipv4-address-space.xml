...
<registry xmlns="http://www.iana.org/assignments" id="ipv4-address-space">
    ...
    <updated>2019-12-27</updated>
    <xref type="rfc" data="rfc7249"/>
    <registration_rule>Allocations to RIRs are made in line with the Global Policy published at<xref type="uri"
                                                                                                     data="http://www.icann.org/en/resources/policy/global-addressing"/>
        .
    ...
    <description>The allocation of Internet Protocol version 4 (IPv4) address space to various registries is listed
        ...
        regional areas of the world. RFC 1466
        <xref type="rfc" data="rfc1466"/>
    ...
    <footnote anchor="2">0.0.0.0/8 reserved for self-identification<xref type="rfc" data="rfc1122"/>, section 3.2.1.3.
        Reserved by protocol. For authoritative registration, see<xref type="registry"
                                                                       data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="3">Reserved for Private-Use Networks<xref type="rfc" data="rfc1918"/>.
        Complete registration details for 10.0.0.0/8 are found in<xref type="registry"
                                                                       data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="4">This was reserved for Public Data Networks<xref type="rfc" data="rfc1356"/>. See<xref
            type="registry" data="public-data-network-numbers"/>.
    ...
    <footnote anchor="5">100.64.0.0/10 reserved for Shared Address Space<xref type="rfc" data="rfc6598"/>.
        Complete registration details for 100.64.0.0/10 are found in<xref type="registry"
                                                                          data="iana-ipv4-special-registry"/>.
    </footnote>
    ...
    <footnote anchor="8">172.16.0.0/12 reserved for Private-Use Networks<xref type="rfc" data="rfc1918"/>.
        Complete registration details are found in<xref type="registry" data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="9">192.0.2.0/24 reserved for TEST-NET-1<xref type="rfc" data="rfc5737"/>.
        Complete registration details for 192.0.2.0/24 are found in<xref type="registry"
                                                                         data="iana-ipv4-special-registry"/>.
        192.88.99.0/24 reserved for 6to4 Relay Anycast
        <xref type="rfc" data="rfc7526"/>
        Complete registration details for 192.88.99.0/24 are found in<xref type="registry"
                                                                           data="iana-ipv4-special-registry"/>.
        192.88.99.2/32 reserved for 6a44 Relay Anycast
        <xref type="rfc" data="rfc6751"/>
        (possibly collocated with 6to4 Relay
        ...
        Complete registration details for 192.168.0.0/16 are found in<xref type="registry"
                                                                           data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="10">192.0.0.0/24 reserved for IANA IPv4 Special Purpose Address Registry<xref type="rfc"
                                                                                                    data="rfc5736"/>.
        Complete registration details for 192.0.0.0/24 are found in<xref type="registry"
                                                                         data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="11">198.18.0.0/15 reserved for Network Interconnect Device Benchmark Testing<xref type="rfc"
                                                                                                        data="rfc2544"/>
        .
        Complete registration details for 198.18.0.0/15 are found in<xref type="registry"
                                                                          data="iana-ipv4-special-registry"/>.
        198.51.100.0/24 reserved for TEST-NET-2<xref type="rfc" data="rfc5737"/>.
        Complete registration details for 198.51.100.0/24 are found in<xref type="registry"
                                                                            data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="12">203.0.113.0/24 reserved for TEST-NET-3<xref type="rfc" data="rfc5737"/>.
        Complete registration details for 203.0.113.0/24 are found in<xref type="registry"
                                                                           data="iana-ipv4-special-registry"/>.
    </footnote>
    <footnote anchor="13">Multicast (formerly "Class D")
        <xref type="rfc" data="rfc5771"/>
        registered in
        <xref type="registry" data="multicast-addresses"/>
    </footnote>
    <footnote anchor="14">Unicast-Prefix-Based IPv4 Multicast Addresses
        <xref type="rfc" data="rfc6034"/>
    </footnote>
    <footnote anchor="15">Administratively Scoped IP Multicast
    ...
    <footnote anchor="17">255.255.255.255 is reserved for "limited broadcast" destination address
        <xref type="rfc" data="rfc919"/>
        and<xref type="rfc" data="rfc922"/>.
        Complete registration details for 255.255.255.255/32 are found in<xref type="registry"
                                                                               data="iana-ipv4-special-registry"/>.
    </footnote>
    <people/>
</registry>
