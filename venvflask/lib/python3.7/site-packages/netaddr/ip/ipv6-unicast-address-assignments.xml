...
<registry xmlns="http://www.iana.org/assignments" id="ipv6-unicast-address-assignments">
    ...
    <description>The allocation of Internet Protocol version 6 (IPv6) unicast address space is listed
        ...
        space can be found in the <xref type="registry" data="ipv6-address-space">IPv6 Address Space registry</xref>.
    </description>
    <note>The assignable Global Unicast Address space is defined in
        <xref type="rfc" data="rfc3513"/>
        as the address block
        defined by the prefix 2000::/3.
        <xref type="rfc" data="rfc3513"/>
        was later obsoleted by<xref type="rfc" data="rfc4291"/>. All address
    ...
    <record date="1999-07-01">
        ...
        <notes>2001:0000::/23 is reserved for IETF Protocol Assignments<xref type="rfc" data="rfc2928"/>.
            ...
            2001:2::/48 is reserved for Benchmarking
    ...
    <record date="2006-10-03">
        ...
        <notes>2400:0000::/19 was allocated on 2005-05-20. 2400:2000::/19 was allocated on 2005-07-08. 2400:4000::/21
            was
    ...
    <record date="2008-04">
        ...
        <whois/>
        <status>RESERVED</status>
        <notes>3ffe::/16 and 5f00::/8 were used for the 6bone but were returned.
            <xref type="rfc" data="rfc5156"/>
        </notes>
    </record>
    <people/>
