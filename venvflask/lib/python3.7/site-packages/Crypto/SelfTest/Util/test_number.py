...
class MiscTests(unittest.TestCase):
    ...
    def test_isPrime(self):
        ...
        self.assertEqual(number.isPrime(1),
                         False)  # Regression test: isPrime(1) caused some versions of PyCrypto to crash.
        ...
        self.assertEqual(number.isPrime(-(2 ** 1279 - 1)),
