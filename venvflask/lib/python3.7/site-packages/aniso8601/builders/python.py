...
class PythonTimeBuilder(BaseTimeBuilder):
    ...
    def build_time(cls, hh=None, mm=None, ss=None, tz=None):
        ...
        if hh is not None:
            if '.' in hh:
                hours, remainingmicroseconds = cls._split_to_microseconds(hh, MICROSECONDS_PER_HOUR,
                                                                          'Invalid hour string.')
        ...
        if ss is not None:
            if '.' in ss:
                seconds, remainingmicroseconds = cls._split_to_microseconds(ss, MICROSECONDS_PER_SECOND,
        ...
        hours, minutes, seconds, microseconds = PythonTimeBuilder._distribute_microseconds(microseconds,
    ...
    def build_duration(cls, PnY=None, PnM=None, PnW=None, PnD=None, TnH=None,
        ...
        if PnY is not None:
            if '.' in PnY:
                years, remainingmicroseconds = cls._split_to_microseconds(PnY, MICROSECONDS_PER_YEAR,
                                                                          'Invalid year string.')
                microseconds += remainingmicroseconds
            else:
        ...
        if PnM is not None:
            if '.' in PnM:
                months, remainingmicroseconds = cls._split_to_microseconds(PnM, MICROSECONDS_PER_MONTH,
        ...
        if PnW is not None:
            if '.' in PnW:
                weeks, remainingmicroseconds = cls._split_to_microseconds(PnW, MICROSECONDS_PER_WEEK,
                                                                          'Invalid week string.')
                microseconds += remainingmicroseconds
            else:
        ...
        if PnD is not None:
            if '.' in PnD:
                days, remainingmicroseconds = cls._split_to_microseconds(PnD, MICROSECONDS_PER_DAY,
                                                                         'Invalid day string.')
                microseconds += remainingmicroseconds
            else:
        ...
        if TnH is not None:
            if '.' in TnH:
                hours, remainingmicroseconds = cls._split_to_microseconds(TnH, MICROSECONDS_PER_HOUR,
                                                                          'Invalid hour string.')
                microseconds += remainingmicroseconds
            else:
        ...
        if TnM is not None:
            if '.' in TnM:
                minutes, remainingmicroseconds = cls._split_to_microseconds(TnM, MICROSECONDS_PER_MINUTE,
                                                                            'Invalid minute string.')
                microseconds += remainingmicroseconds
            else:
        ...
        if TnS is not None:
            if '.' in TnS:
                seconds, remainingmicroseconds = cls._split_to_microseconds(TnS, MICROSECONDS_PER_SECOND,
                                                                            'Invalid second string.')
                microseconds += remainingmicroseconds
            else:
        ...
        years, months, weeks, days, hours, minutes, seconds, microseconds = PythonTimeBuilder._distribute_microseconds(
            microseconds, (years, months, weeks, days, hours, minutes, seconds), (
            MICROSECONDS_PER_YEAR, MICROSECONDS_PER_MONTH, MICROSECONDS_PER_WEEK, MICROSECONDS_PER_DAY,
